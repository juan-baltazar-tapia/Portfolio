  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 py-24 relative z-10 text-center flex flex-col items-center justify-center h-full">
        <h1 className="text-7xl font-bold ml-24 mr-24 mb-12 text-slate-100 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] dark:text-white mt-20">
        ...
        <ul className="flex justify-center space-x-8">
          <li>
            <a
              href="#projects"
              className="text-2xl text-white hover:text-gray-300 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] transition duration-300"
            >
              View Projects
            </a>
          </li>
